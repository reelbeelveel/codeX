// Script modified: Mon August 10, 2020 @ 12:57:51 EDT
    ...
    try {
        ...
        switch(value.arg) {
            case 'img': 
                ...
                console.log('    -> opened puppeteer browser');
                ...
                console.log('    -> viewport and watermark set successfully');
